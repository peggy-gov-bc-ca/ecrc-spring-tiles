 ...
 */
@Controller
public class ShareEivFailedController {
	...
	// Display the form on the get request
		@RequestMapping(value="/secure/shareEivFailed.htm", method = RequestMethod.GET)
		public String showEivFailedDetails(HttpServletRequest request, Map<String, Object> model) throws ECRCException {
			
			String titlePrefix = sessionVars.getEcrc_props().getProperty("title.share");
			String pageTitle = sessionVars.getEcrc_props().getProperty("title.share.eiv.failed");
			...
			request.setAttribute("scenario_result", sessionVars.getEcrc_props().getProperty("dcsext.scenario_result.share.eiv.failed"));
			
			return "shareEivFailed";
		}
