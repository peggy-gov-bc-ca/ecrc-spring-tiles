 <!-- ***** Footer Start ***** //-->
   <div class="ls-row" id="row-footer">
      <div class="ls-fxr" id="ls-gen16-ls-fxr">
         <div class="ls-area" id="area-footer">
            <div class="ls-area-body" id="ls-gen17-ls-area-body">
               <div class="ls-cmp-wrap ls-1st" id="w1328897957815">
                  <div class="iw_component" id="1328897957815">
                     <div id="footer_theme_links_container">
                        <div class="footer_theme_links">
                           <h3>
               ...
               <div class="ls-cmp-wrap" id="w1328897957814">
                  <div class="iw_component" id="1328897957814">
                     <div id="footer_container">
                        <div id="footer">
                           <div id="media_links">
                              <a href="http://www2.gov.bc.ca/gov/index.page?"><img alt="B.C. Home" src="${pageContext.request.contextPath}/assets/img/bc_logo.gif"></a>
                              <ul>
                                 <li>
                                    <a href="http://www.youtube.com/ProvinceofBC">YouTube</a>
                                 </li>
                                 <li>
                                    <a href="http://www.newsroom.gov.bc.ca/connect.html#facebook">Facebook</a>
                                 </li>
                                 <li>
                                    <a href="http://www.newsroom.gov.bc.ca/connect.html#twitter">Twitter</a>
                                 </li>
                                 <li>
                                    <a href="http://www.newsroom.gov.bc.ca/connect.html#blogs">Blogs</a>
                                 </li>
                                 <li>
                                    <a href="http://www.newsroom.gov.bc.ca/connect.html#rss">RSS Feeds</a>
                                 </li>
                                 <li>
                                    <a href="http://www.enewsletters.gov.bc.ca/">E-Newsletters</a>
                                 </li>
                                 <li>
                                    <a href="http://www.newsroom.gov.bc.ca/ministries/">Ministry Media Rooms</a>
                                 </li>
                              </ul>
                           </div>
                           <div id="admin_links">
                              <ul>
                                 <li>
                                    <a href="http://www2.gov.bc.ca/gov/admin/disclaimer.page">Disclaimer</a>
                                 </li>
                                 <li>
                                    <a href="http://www2.gov.bc.ca/gov/admin/privacy.page">Privacy</a>
                                 </li>
                                 <li>
                                    <a href="http://www2.gov.bc.ca/gov/admin/accessibility.page">Accessibility</a>
                                 </li>
                                 <li>
                                    <a href="http://www2.gov.bc.ca/gov/admin/copyright.page">Copyright</a>
                                 </li>
                                 <li>
                                    <a href="https://extranet.gov.bc.ca/forms/gov/contact/index.html">Contact Us</a>
                                 </li>
                              </ul>
                           </div>
                        </div>
